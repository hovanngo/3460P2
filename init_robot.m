...
Px100.currentConfig = Px100.config;
...
for i = 1:length(Px100.DXL_ID)
    ...
    write1ByteTxRx(Px100.port_num, Px100.PROTOCOL_VERSION, Px100.DXL_ID(i), Px100.ADDR_TORQUE_ENABLE, Px100.TORQUE_DISABLE);
